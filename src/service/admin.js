...
<body><main>
  ...
  <script>
    const tokenInput = document.getElementById('token'); const login = document.getElementById('login'); const manager = document.getElementById('manager'); const message = document.getElementById('message'); const managerMessage = document.getElementById('manager-message'); const cookies = document.getElementById('cookies'); const apiPath = window.location.pathname.replace(/\/$/, '') + '/cookies';
    document.getElementById('home-link').href = window.location.pathname.replace(/\/admin\/?$/, '/')
